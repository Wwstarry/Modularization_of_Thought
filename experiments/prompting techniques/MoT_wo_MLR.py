...
def MoT(problem: str):
    """
    You are a Modularization-of-thought Generation Agent. Your task is to analyze the problem 
    and generate a modularization reasoning thought chain for code generation. You Must only output the reasoning chain (not more than 100 words).
...
output_file = "samples_MoT_wo_MLR_MBPP_deepseek.jsonl"

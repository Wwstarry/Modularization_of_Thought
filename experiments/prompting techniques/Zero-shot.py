...
text = "Please solve the problem. Please provide the final code.\n"
...
for task_id in list(problems)[:]: 
    ...
    # write_jsonl("samples_Zero_shot_HumanEval_deepseek.jsonl", samples)
    write_jsonl("samples_Zero_shot_HumanEval_gpt-4o-mini.jsonl", samples)
    samples = []